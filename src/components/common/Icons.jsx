/**
 * Icons Component - Reusable SVG Icons
 * Using Heroicons (MIT License) style
 * All icons have consistent 24x24 viewBox
 */

// Shopping Cart Icon
export function ShoppingCartIcon({ className = '', ...props }) {
    return (
        <svg
            className={className}
            viewBox="0 0 24 24"
...
// Star Icon (Filled)
export function StarIcon({ className = '', filled = false, ...props }) {
    return (
        <svg
            className={className}
            viewBox="0 0 24 24"
...
// Loader/Spinner Icon
export function LoaderIcon({ className = '', ...props }) {
    return (
        <svg
            className={className}
            viewBox="0 0 24 24"
...
// Heart Icon
export function HeartIcon({ className = '', filled = false, ...props }) {
    return (
        <svg
            className={className}
            viewBox="0 0 24 24"
